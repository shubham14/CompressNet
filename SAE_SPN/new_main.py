...
def main():
	...
	saved_state_dict1 = {k: v for k, v in saved_state_dict1.items() if 'decoder.conv_tr4' not in k }
	saved_state_dict1.update(saved_dict)
	CompressNet.load_state_dict(saved_state_dict1, strict = False)
