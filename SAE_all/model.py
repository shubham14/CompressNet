...
class Model(nn.Module):
    ...
    def forward(self, input_data, evaluate=False):
        ...
        # =======================================================================================================>>>
        feature_map, self.intermediate_layers = self.encoder(self.example)#, config, self.training_phase, self.config.channel_bottleneck)
        ...
        self.reconstruction, self.rec_intermediate_layers = self.decoder(z)#, config, self.training_phase, C=self.config.channel_bottleneck)
